...
// git add . ; git commit -m "添加Singureo和doujinstyle" ; git push origin main
...
const config: Config = {
  ...
  plugins: [
    ...
    //   },
    // ],
    'docusaurus-plugin-sass', 'docusaurus-plugin-zooming'],
  themes: [
    [
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      logo: {
        alt: 'uoht Logo',
        src: 'https://p.inari.site/usr/1818/692e781f6ce90.jpg',
      },
      items: [
